...
- [ ] **Mobile nav menu doesn't work** — `index.html` loads `index.js`, which doesn't exist. The actual script (`script.js`, containing the hamburger-menu toggle logic) never loads. Fix: point the `<script>` tag at `script.js`.
